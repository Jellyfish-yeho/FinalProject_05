...
<div id="app1" class="container2 d-flex justify-content-end align-items-center" style="background-color: #014618;">
	<div v-if="id != ''">
...
<nav class="navbar navbar-light navbar-expand-sm " style="background-color: #ffffff;">
	<div class="container">
		...
		<ul class="navbar-nav me-auto centered">
			<li class="nav-item me-5">
				<a class="nav-link fw-bold" href="${pageContext.request.contextPath}/">
			...
			<li class="nav-item me-5">
				<a class="align-middle nav-link ${empty param.thisPage?'active':''}" href="${pageContext.request.contextPath}/">홈</a>
			</li>
			<li class="nav-item me-5">
