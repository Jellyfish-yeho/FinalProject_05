	...
	<div id="app1" class="container" style="background-color: #014618;">
		...
		<div class="collapse navbar-collapse me-5" id="navbarNav">
			<ul class="navbar-nav me-auto">
				...
				<li class="nav-item">
					<a class="nav-link me-4 ${param.thisPage eq 'notice'?'active':''}" href="${pageContext.request.contextPath}/notice/list.do">공지사항</a>
				</li>
				<li class="nav-item">
					<a class="nav-link me-4 ${param.thisPage eq 'cafe'?'active':''}" href="${pageContext.request.contextPath}/cafe/list.do">자유게시판</a>
				</li>
				<li class="nav-item">
					<a class="nav-link me-4 ${param.thisPage eq 'gallery'?'active':''}" href="${pageContext.request.contextPath}/gallery/list.do">갤러리</a>
				</li>
				<li class="nav-item">
					<a class="nav-link me-4 ${param.thisPage eq 'faq'?'active':''}" href="${pageContext.request.contextPath}/faq/faq.do">FAQ</a>
				</li>
			</ul>
		</div>
